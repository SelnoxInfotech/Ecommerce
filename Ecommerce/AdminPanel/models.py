...
from AdminPanel.Coupoun import ClaimedCoupon,ClaimGiftVoucher
import calendar
...
class Stores(models.Model):
    ...
    Store_Type=models.CharField(max_length=50,choices=StoreType,default=None)
...
class Product(models.Model):                #Product
    ...
    SubTotal=models.IntegerField(blank=True,null=True,default=None)
    ...
    def save(self,*args,**kwargs):
        if self.discount.Discount_value>0:
            ...
            self.SubTotal=self.DiscountedAmount
        else:
        ...
        if  self.tax.tax_value>0:
            ...
            self.SubTotal=self.taxedAmount
        ...
        if self.prices>5 and self.DiscountedAmount!=0:
            ...
            self.SubTotal=self.After_Coupoun_Price
        ...
        if self.Claimed_Coupoun.coupon.percentage==0 or self.Claimed_Coupoun.coupon.percentage==None:
            ...
            self.SubTotal=self.After_GiftVoucher

...
from Product.models import Category,SubCategory,Countries,States,Cities,StrainType,Brand,Product,taxes,Discount
from datetime import datetime
from Product.serializer import Serializer_Category,Serializer_SubCategory,Serializer_Country,Serializer_States,Serializer_Cities,Serializer_StrainType,Serializer_Product,Serializer_Brand,Serializer_tax,Serializer_Discount
